...
### GIS Internals
By default, it is installed under `C:\Program Files\GDAL`. We can start with GDAL specified command terminal 
`C:\Windows\SysWOW64\cmd.exe /k "C:\Program Files\GDAL\GDALShell.bat"`
The Shell correctly set all the environmental variables in the terminal. This is how it avoids the conflicts with PostGIS and turns out to be a better option than OSGEO4W. This command has been created as a command shell in Windows and can be lauched from the Apps menu.
...
[comment]: # Local Folder: "D:\Cloud_Drive\Dropbox (Hunter  College)\Workspace/PythonLand/PySQL"

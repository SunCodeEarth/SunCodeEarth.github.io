---
title: PostgreSQL/PostGIS with/ instllation
author: Shipeng Sun
date: '2022-07-01'
...
[Using EnterpriseDB installer to install PostgreSQL](https://www.postgresql.org/download/windows/) and [using Stackbuilder to install PostGIS](http://www.bostongis.com/PrinterFriendly.aspx?content_name=postgis_tut01) is very easy. However, PostgreSQL/PostGIS as a service as the result of such installations has some overhead because it is running in the background no matter it is actually used or not. Note that PostgreSQL has a small footprint when in "idle". Nevertheless, it could be useful to run PostgreSQL/PostGIS as needed.
...
@ECHO Intialize a database cluster (data folder/directory) using initdb
...
[comment]: # Local Folder: "D:\Cloud_Drive\Dropbox (Hunter   College)\Workspace\PythonLand\GDB_Topo"
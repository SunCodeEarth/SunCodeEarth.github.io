...
The data largely contain metadata at SI, 3D models, and pictures. To access the data, [the ASW CLI tool](https://docs.aws.amazon.com/cli/latest/userguide/cli-chap-welcome.html) can be used. CLI commands for S3 is available [there, too](https://docs.aws.amazon.com/cli/latest/userguide/cli-services-s3-commands.html).

...
class BubbleUI {
    ...
    constructor(div_id, options = {}) {
        ...
        this.nTop = 0;
        this.maxSubN = this.options.maxSubChidrenNum;
        this.colN = 0;
        this.rowN = 0;
    ...
    reset() {
        ...
        for (var iB = 0; iB < this.nTop; iB++) {
            t.selectAll(".childBubbleText" + iB)
                .style("opacity", 0.5)
                .attr("font-size", 6)
                .attr("x", (d, i) => this.subBubblePos(i, centerXs[iB], centerYs[iB], oR, this.maxSubN, 0.88, 'x'))
                .attr("y", (d, i) => this.subBubblePos(i, centerXs[iB], centerYs[iB], oR, this.maxSubN, 0.88, 'y'));
            ...
            */
            t.selectAll(".childBubble" + iB)
                .attr("r", (d, i) => this.subBubblePos(i, centerXs[iB], centerYs[iB], oR, this.maxSubN, 0.88, 'r'))
                .attr("cx", (d, i) => this.subBubblePos(i, centerXs[iB], centerYs[iB], oR, this.maxSubN, 0.88, 'x'))
                .attr("cy", (d, i) => this.subBubblePos(i, centerXs[iB], centerYs[iB], oR, this.maxSubN, 0.88, 'y'))
                .style("opacity", 0.5);
        }
    ...
    activate(i) {
        ...
        for (let k = 0; k < this.nTop; k++) {
            ...
            t.selectAll(".childBubbleText" + k)
                .attr("x", (d, i) => this.subBubblePos(i, centerXs[k], centerYs[k], centerRs[k], this.maxSubN, 0.68, 'x'))
                .attr("y", (d, i) => this.subBubblePos(i, centerXs[k], centerYs[k], centerRs[k], this.maxSubN, 0.68, 'y'))
                .attr("font-size", () => k == i ? 12 : 6)
                .style("opacity", () => k == i ? 1 : 0);

            t.selectAll(".childBubble" + k)
                .attr("cx", (d, i) => this.subBubblePos(i, centerXs[k], centerYs[k], centerRs[k], this.maxSubN, 0.68, 'x'))
                .attr("cy", (d, i) => this.subBubblePos(i, centerXs[k], centerYs[k], centerRs[k], this.maxSubN, 0.68, 'y'))
                .attr("r", (d, i) => this.subBubblePos(i, centerXs[k], centerYs[k], centerRs[k], this.maxSubN, 0.98, 'r'))
                .style("opacity", () => k == i ? 1 : 0);
        }
